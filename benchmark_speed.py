...
def benchmark_speed_ops(shapes, op_nanograd, op_pytorch=None, name='None'):
    ...
    BENCHMARKS[name] = (ng_cpu_time, pt_cpu_time, ng_gpu_time)
...
if __name__ == '__main__':
    ...
    print('Benchmarking fourth ops...')
    benchmark_speed_ops([(30, 40, 20, 10)],         lambda x: x[10:20, 4:5, :12, 0:-1], name='getitem_2')

    benchmark_speed_ops([(30, 30, 30)],             lambda x: x.squeeze(axis=1), name='squeeze_1')

    benchmark_speed_ops([(30, )],                   lambda x: x.unsqueeze(1), name='unsqueeze')
